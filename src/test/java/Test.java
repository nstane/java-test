...
public class Test {
	...
	public final static Comparator<Person> COMPARATOR = Comparator.comparing(Person::getfName) .thenComparing(Person::getfName);
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//throw exception java.lang.IllegalMonitorStateException if use without synchronized block or method
			//o.wait();
			//o.notify();
		}
	...
	private static void test(){
		//Tree set not allow null because it use binary tree and sort element so it will throw null pointer exception
...
class A {
	public void blah() {System.out.println("a");}
}
